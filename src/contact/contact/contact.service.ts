...
export class ContactService {
  ...
  async checkContactMustExists(
    ...
    const contact: Contact | null = await this.prismaService.contact.findFirst({
      where: {
        username: username,
        id: contactId,
      },
  ...
  async create(
    ...
    const validateRequest: CreateContactRequest =
      this.validationService.validate<CreateContactRequest>(
  ...
  async update(
    ...
    const validateRequest: UpdateContactRequest =
      this.validationService.validate<UpdateContactRequest>(
  ...
  async search(
    ...
    const validateRequest: SearchContactRequest =
