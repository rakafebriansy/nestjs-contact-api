...
export class AddressService {
  ...
  async get(user: User, request: GetAddressRequest): Promise<AddressResponse> {
    const validatedRequest: GetAddressRequest =
      this.validationService.validate<GetAddressRequest>(
  ...
  async update(
    ...
    const validatedRequest: UpdateAddressRequest =
      this.validationService.validate<UpdateAddressRequest>(
  ...
  async remove(
    ...
    const validatedRequest: RemoveAddressRequest =
      this.validationService.validate<RemoveAddressRequest>(
